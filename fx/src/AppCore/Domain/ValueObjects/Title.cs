...
public class Title : ValueObject
{
    ...
    private Title(string value)
    {
        ...
        {
            throw new InvalidValueObjectStateExceptions("ValidationErrorIsRequire {0}", nameof(Title));
        }
        if (value.Length < 2 || value.Length > 250)
        {
            throw new InvalidValueObjectStateExceptions("ValidationErrorStringLength {0} 2 250", nameof(Title));
        }
        Value = value;
    }
    private Title() { }
