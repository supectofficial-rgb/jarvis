...
public sealed class CatalogApiService : ICatalogApiService
{
    ...
    public Task<ApiResponse<bool>> RemoveVariantComponentAsync(string variantId, string componentVariantId, string token) => _apiService.RemoveVariantComponentAsync(variantId, componentVariantId, token);
