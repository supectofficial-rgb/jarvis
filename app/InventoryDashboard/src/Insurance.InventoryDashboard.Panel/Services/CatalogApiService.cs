...
public sealed class CatalogApiService : ICatalogApiService
{
    ...
    public Task<ApiResponse<bool>> RemoveVariantTagAsync(string variantId, string? tagId, string? tagRef, string? tagName, string token) => _apiService.RemoveVariantTagAsync(variantId, tagId, tagRef, tagName, token);
