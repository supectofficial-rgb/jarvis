...
public sealed class CatalogApiService : ICatalogApiService
{
    ...
    public Task<ApiResponse<bool>> RemoveVariantComponentAsync(string variantComponentBusinessKey, string token) => _apiService.RemoveVariantComponentAsync(variantComponentBusinessKey, token);
    ...
    public Task<ApiResponse<bool>> RemoveVariantTagAsync(string variantTagBusinessKey, string token) => _apiService.RemoveVariantTagAsync(variantTagBusinessKey, token);
    ...
    public Task<ApiResponse<ProductVariantSearchResultModel>> SearchProductVariantsAsync(string token, string? searchTerm = null, string? productId = null, string? categoryId = null, string? attributeOptionIds = null, string? attributeFiltersJson = null, bool? isActive = null, int page = 1, int pageSize = 10) => _apiService.SearchProductVariantsAsync(token, searchTerm, productId, categoryId, attributeOptionIds, attributeFiltersJson, isActive, page, pageSize);
