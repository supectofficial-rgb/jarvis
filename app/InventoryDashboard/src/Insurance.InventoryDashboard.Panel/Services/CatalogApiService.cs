...
public sealed class CatalogApiService : ICatalogApiService
{
    ...
    public Task<ApiResponse<List<VariantInventoryTransactionModel>>> GetInventoryTransactionsByVariantAsync(string variantId, string token) => _apiService.GetInventoryTransactionsByVariantAsync(variantId, token);
