namespace Insurance.InventoryService.AppCore.AppServices.Catalog.Categories.Commands.UpdateCategoryAttributeRule;
...
public class UpdateCategoryAttributeRuleCommandHandler : CommandHandler<UpdateCategoryAttributeRuleCommand, UpdateCategoryAttributeRuleCommandResult>
{
    ...
    public UpdateCategoryAttributeRuleCommandHandler(
    ...
    public override async Task<CommandResult<UpdateCategoryAttributeRuleCommandResult>> Handle(UpdateCategoryAttributeRuleCommand command)
    {
        ...
        var existingRule = category.AttributeRules.FirstOrDefault(x => x.AttributeRef == command.AttributeRef);
        ...
        category.AddAttributeRule(
            ...
            changeSummary: $"Update category rule for attribute {command.AttributeRef}");
        await _categoryRepository.CommitAsync();

        return Ok(new UpdateCategoryAttributeRuleCommandResult
        {
