namespace Insurance.InventoryService.AppCore.AppServices.InventoryDocuments.Commands.CreateAdjustmentDocument;
...
public class CreateAdjustmentDocumentCommandHandler : CommandHandler<CreateAdjustmentDocumentCommand, Guid>
{
