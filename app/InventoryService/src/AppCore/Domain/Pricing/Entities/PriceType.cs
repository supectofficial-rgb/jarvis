...
public sealed class PriceType : AggregateRoot
{
    ...
    private PriceType(string code, string name)
    {
    ...
    public static PriceType Create(string code, string name) => new(code, name);
