...
public sealed class QualityStatus : AggregateRoot
{
    ...
    private QualityStatus(string code, string name)
    {
    ...
    public static QualityStatus Create(string code, string name) => new(code, name);
