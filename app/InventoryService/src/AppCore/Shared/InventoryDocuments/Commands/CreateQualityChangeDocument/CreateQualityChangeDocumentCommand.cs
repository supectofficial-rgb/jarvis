namespace Insurance.InventoryService.AppCore.Shared.InventoryDocuments.Commands.CreateQualityChangeDocument;

using Insurance.InventoryService.AppCore.Shared.InventoryDocuments.Commands;
using OysterFx.AppCore.Shared.Commands;

public class CreateQualityChangeDocumentCommand : ICommand<Guid>
{
