...
public class GetInventoryDocumentLinesByDocumentQueryResult
{
    public List<InventoryDocumentLineListItem> Items { get; set; } = new();
}

public class InventoryDocumentLineListItem
{
