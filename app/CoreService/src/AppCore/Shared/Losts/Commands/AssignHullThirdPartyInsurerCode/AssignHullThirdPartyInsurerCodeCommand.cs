namespace Insurance.AppCore.Shared.Losts.Commands.AssignHullThirdPartyInsurerCode;
...
/// </summary>
public class AssignHullThirdPartyInsurerCodeCommand : ICommand<Guid>
{
    ...
    /// مشخصات زیان دیده
    /// </summary>
    public ClaimantInfoDto ClaimantInfo { get; set; }
}
